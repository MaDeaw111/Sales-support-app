...
CREATE TABLE po_audit_events (
    ...
    event_type TEXT NOT NULL CHECK(event_type IN ('PO_CREATED', 'REVISION_CREATED', 'REVISION_ACTIVATED', 'REVISION_SUPERSEDED', 'PO_LINE_ADDED', 'PO_LINE_REMOVED', 'DOCUMENT_ADDED', 'DOCUMENT_UPDATED', 'OPERATIONAL_NOTE_UPDATED', 'PO_CANCELLED', 'SPEC_OLD_REVISION_CONFIRMED', 'PRICE_OVERRIDE_USED')),
